...
public class WelcomeBGparams {
    ...
    public static final String QRCODE_TEXT = "ticket_qrcode_text";
    public static final String BARCODE_HEIGHT = "ticket_qrcode_height";
    public static final String QRCODE_LEFT = "ticket_qrcode_left";
    public static final String QRCODE_SIZE = "ticket_qrcode_size";
    ...
    private Insets createInsets(String str) {
        ...
        if (ints.size() != 4) {
            log.warn("Value \"" + str + "\" must has 4 digits but " + ints.size() + " found.");
            return null;
        }
    ...
    public ArrayList<Integer> getScreenGaps(Long id) {
        ...
        if (ints.size() != 2) {
            log.warn(property + " Value \"" + property.getValue() + "\" must has 2 digits but " + ints.size() + " found.");
            return null;
        }
        return ints;
    }
