...
/**
 * Форма выбора и установки языковой локкали.
 *
...
public class FLangsOnWelcome extends javax.swing.JFrame {
    ...
    private final ArrayList<JCheckBox> bxs = new ArrayList<>();
    ...
    private void initComponents() {
        ...
        langsMenuBar = new javax.swing.JMenuBar();
        menuFile = new javax.swing.JMenu();
        menuLangs = new javax.swing.JMenu();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FLangsOnWelcome.class);
        ...
        langsMenuBar.setName("langsMenuBar"); // NOI18N
        ...
        langsMenuBar.add(menuFile);

        setJMenuBar(langsMenuBar);
    ...
    private void btnOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOKActionPerformed
        bxs.stream().forEach(cb -> Locales.getInstance().setLangWelcome(cb.getText(), cb.isSelected()));
    ...
    /**
     * Выставим текущую локаль. По списку существующих.
     */
    ...
    private javax.swing.JMenuBar langsMenuBar;
