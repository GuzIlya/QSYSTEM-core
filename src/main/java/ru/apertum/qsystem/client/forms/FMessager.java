...
public class FMessager extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FMessager.class);
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance().getContext().getActionMap(FMessager.class, this);
    ...
    public void sendMessage() {
        ...
        if (checkBoxAll.isSelected()) {
            ...
            listUsers.getSelectedValuesList().stream().forEach(o ->
                    message.append("@" + ((QUser) o).getId().toString() + "@")
            );
            if (treeServices.getSelectionPaths() != null) {
                for (Object path : treeServices.getSelectionPaths()) {
                    final TreePath selectedPath = (TreePath) path;
                    final QService service = (QService) selectedPath.getLastPathComponent();

                    QServiceTree.sailToStorm(service, (TreeNode service1) ->
                            message.append("@" + ((QService) service1).getId().toString() + "@")
                    );
                }
            }
        }
