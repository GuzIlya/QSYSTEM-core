...
public class FSpecScheduleDialog extends javax.swing.JDialog {
    ...
    public static QSpecSchedule changeQSpecSchedule(Frame parent, boolean modal, QSpecSchedule sps) {
        log.info(format(java.util.ResourceBundle.getBundle("ru/apertum/qsystem/client/forms/resources/FSpecScheduleDialog").getString("edit_spec"),
                sps == null ? "NEW" : sps.getName()));
        if (dialog == null) {
