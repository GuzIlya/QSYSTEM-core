...
public class FInputDialog extends javax.swing.JDialog {
    ...
    private void init() {
        panelButtonsNumeric.setVisible(WelcomeParams.getInstance().numericKeyboard);
        panelLettersUp.setVisible(WelcomeParams.getInstance().alphabeticKeyboard);
        panelLettersMiddle.setVisible(WelcomeParams.getInstance().alphabeticKeyboard);
        panelLettersMiddleLeft.setVisible(WelcomeParams.getInstance().alphabeticKeyboard);
        panelLettersMiddleRight.setVisible(WelcomeParams.getInstance().alphabeticKeyboard);
        panelLettersBottom.setVisible(WelcomeParams.getInstance().alphabeticKeyboard);
        panelLettersBottomLeft.setVisible(WelcomeParams.getInstance().alphabeticKeyboard);
        panellLettersBottomRight.setVisible(WelcomeParams.getInstance().alphabeticKeyboard);
        panelSpase.setVisible(WelcomeParams.getInstance().alphabeticKeyboard);
        panelSpaseLeft.setVisible(WelcomeParams.getInstance().alphabeticKeyboard);
        panelSpaseRight.setVisible(WelcomeParams.getInstance().alphabeticKeyboard);
        labelKod.setFont(new Font("arial", 0, WelcomeParams.getInstance().inputFontSize));

        panelSpecButtons.setVisible(!"".equals(WelcomeParams.getInstance().specKeyboard));
        if (!"".equals(WelcomeParams.getInstance().specKeyboard)) {
            final String[] ss = WelcomeParams.getInstance().specKeyboard.split(";");
     ...
     * @param caption     Заголовок на форме диалога.
    ...
    public static String showInputDialog(Frame parent, boolean modal, INetProperty netProperty, boolean fullscreen, int delay, String caption) {
        ...
        log.info("Ввод клиентской информации");
        if (inputDialog == null) {
        ...
        inputDialog.labelKod.setText(inputDialog.map.getString("labelKod.text"));
    ...
    private void initComponents() {
        ...
        panelAll = new QPanel(WelcomeParams.getInstance().getBackgroundImg("input"));
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FInputDialog.class);
        ...
        buttonSpaceV.setBorder(javax.swing.BorderFactory.createCompoundBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED), javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED)));
    ...
    private final transient org.jdesktop.application.ResourceMap map = org.jdesktop.application.Application.getInstance(ru.apertum.qsystem.QSystem.class).getContext().getResourceMap(FInputDialog.class);

    private void changeTextToLocale() {
        jButton1.setText(map.getString("jButton1.text")); // NOI18N
        jButton2.setText(map.getString("jButton2.text")); // NOI18N
        labelKod.setText(map.getString("labelKod.text")); // NOI18N

        buttonSpaceV.setText(map.getString("buttonSpaceV.text")); // NOI18N
        jButton14.setText(map.getString("jButton14.text")); // NOI18N
        jButton15.setText(map.getString("jButton15.text")); // NOI18N
        jButton16.setText(map.getString("jButton16.text")); // NOI18N
        jButton17.setText(map.getString("jButton17.text")); // NOI18N
        jButton18.setText(map.getString("jButton18.text")); // NOI18N
        jButton19.setText(map.getString("jButton19.text")); // NOI18N
        jButton20.setText(map.getString("jButton20.text")); // NOI18N
        jButton21.setText(map.getString("jButton21.text")); // NOI18N
        jButton22.setText(map.getString("jButton22.text")); // NOI18N
        jButton23.setText(map.getString("jButton23.text")); // NOI18N
        jButton24.setText(map.getString("jButton24.text")); // NOI18N
        jButton25.setText(map.getString("jButton25.text")); // NOI18N
        jButton26.setText(map.getString("jButton26.text")); // NOI18N
        jButton27.setText(map.getString("jButton27.text")); // NOI18N
        jButton28.setText(map.getString("jButton28.text")); // NOI18N
        jButton29.setText(map.getString("jButton29.text")); // NOI18N
        jButton30.setText(map.getString("jButton30.text")); // NOI18N
        jButton31.setText(map.getString("jButton31.text")); // NOI18N
        jButton32.setText(map.getString("jButton32.text")); // NOI18N
        jButton33.setText(map.getString("jButton33.text")); // NOI18N
        jButton34.setText(map.getString("jButton34.text")); // NOI18N
        jButton35.setText(map.getString("jButton35.text")); // NOI18N
        jButton36.setText(map.getString("jButton36.text")); // NOI18N
        jButton37.setText(map.getString("jButton37.text")); // NOI18N
        jButton38.setText(map.getString("jButton38.text")); // NOI18N
        jButton39.setText(map.getString("jButton39.text")); // NOI18N
        jButton40.setText(map.getString("jButton40.text")); // NOI18N
        jButton41.setText(map.getString("jButton41.text")); // NOI18N
        jButton42.setText(map.getString("jButton42.text")); // NOI18N
        jButton43.setText(map.getString("jButton43.text")); // NOI18N
        jButton44.setText(map.getString("jButton44.text")); // NOI18N
        jButton45.setText(map.getString("jButton45.text")); // NOI18N
        jButton46.setText(map.getString("jButton46.text")); // NOI18N
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (labelKod.getText().length() != 0 && !map.getString("labelKod.text").equals(labelKod.getText())) {
            if (clockBack.isActive()) {
                clockBack.stop();
            }
    ...
    private void buttonClickNumeric(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonClickNumeric
        ...
        if ("".equals(evt.getActionCommand())) {
            // удаление
            if (map.getString("labelKod.text").equals(labelKod.getText().replace("<html>", "")) || "".equals(labelKod.getText().replace("<html>", ""))) {
                labelKod.setText("");
            } else {
                String text = labelKod.getText().substring(0, labelKod.getText().length() - 1);
                if (text.endsWith(" ")) {
                    text = text.substring(0, text.length() - 1) + "_";
                }
                labelKod.setText(text);
            }

        } else {
            // добавление цифры
            if (map.getString("labelKod.text").equals(labelKod.getText())) {
                labelKod.setText("");
            }
