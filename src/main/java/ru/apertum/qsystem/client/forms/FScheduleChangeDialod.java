...
public class FScheduleChangeDialod extends javax.swing.JDialog {
    ...
    public static void changeSchedule(Frame parent, boolean modal, QSchedule schedule) {
        log.info("Редактирование услуги \"" + schedule.getName() + "\"");
    ...
    private void loadSchedule(QSchedule schedule) {
        ...
        c1.setSelected(schedule.getTimeBegin1() != null && schedule.getTimeEnd1() != null);
        if (c1.isSelected()) {
            s1.setText(formatHhMm.format(schedule.getTimeBegin1()));
            e1.setText(formatHhMm.format(schedule.getTimeEnd1()));
        }
        c2.setSelected(schedule.getTimeBegin2() != null && schedule.getTimeEnd2() != null);
        if (c2.isSelected()) {
            s2.setText(formatHhMm.format(schedule.getTimeBegin2()));
            e2.setText(formatHhMm.format(schedule.getTimeEnd2()));
        }
        c3.setSelected(schedule.getTimeBegin3() != null && schedule.getTimeEnd3() != null);
        if (c3.isSelected()) {
            s3.setText(formatHhMm.format(schedule.getTimeBegin3()));
            e3.setText(formatHhMm.format(schedule.getTimeEnd3()));
        }
        c4.setSelected(schedule.getTimeBegin4() != null && schedule.getTimeEnd4() != null);
        if (c4.isSelected()) {
            s4.setText(formatHhMm.format(schedule.getTimeBegin4()));
            e4.setText(formatHhMm.format(schedule.getTimeEnd4()));
        }
        c5.setSelected(schedule.getTimeBegin5() != null && schedule.getTimeEnd5() != null);
        if (c5.isSelected()) {
            s5.setText(formatHhMm.format(schedule.getTimeBegin5()));
            e5.setText(formatHhMm.format(schedule.getTimeEnd5()));
        }
        c6.setSelected(schedule.getTimeBegin6() != null && schedule.getTimeEnd6() != null);
        if (c6.isSelected()) {
            s6.setText(formatHhMm.format(schedule.getTimeBegin6()));
            e6.setText(formatHhMm.format(schedule.getTimeEnd6()));
        }
        c7.setSelected(schedule.getTimeBegin7() != null && schedule.getTimeEnd7() != null);
        if (c7.isSelected()) {
            s7.setText(formatHhMm.format(schedule.getTimeBegin7()));
            e7.setText(formatHhMm.format(schedule.getTimeEnd7()));
        }
        radioButtonWeek.setSelected(schedule.getType() == 0);
        radioButtonChet.setSelected(schedule.getType() == 1);

        QBreaks[] breaks = QBreaksList.getInstance().getItems().toArray(new QBreaks[0]);
        breaks = ArrayUtils.addAll(new QBreaks[1], breaks);

        cb1.setModel(new DefaultComboBoxModel(breaks));
        cb2.setModel(new DefaultComboBoxModel(breaks));
        cb3.setModel(new DefaultComboBoxModel(breaks));
        cb4.setModel(new DefaultComboBoxModel(breaks));
        cb5.setModel(new DefaultComboBoxModel(breaks));
        cb6.setModel(new DefaultComboBoxModel(breaks));
        cb7.setModel(new DefaultComboBoxModel(breaks));


        cb1.setSelectedItem(schedule.getBreaks1());
        cb2.setSelectedItem(schedule.getBreaks2());
        cb3.setSelectedItem(schedule.getBreaks3());
        cb4.setSelectedItem(schedule.getBreaks4());
        cb5.setSelectedItem(schedule.getBreaks5());
        cb6.setSelectedItem(schedule.getBreaks6());
        cb7.setSelectedItem(schedule.getBreaks7());
    }

    private QSchedule schedule;

    private void checkInterval(Date start, Date finish) {
        try {
            new QSchedule.Interval(start, finish);
    ...
    private void saveSchedule() throws ParseException {
        if (c1.isSelected()) {
            checkInterval(formatHhMm.parse(s1.getText()), formatHhMm.parse(e1.getText()));
        }
        if (c2.isSelected()) {
            checkInterval(formatHhMm.parse(s2.getText()), formatHhMm.parse(e2.getText()));
        }
        if (c3.isSelected()) {
            checkInterval(formatHhMm.parse(s3.getText()), formatHhMm.parse(e3.getText()));
        }
        if (c4.isSelected()) {
            checkInterval(formatHhMm.parse(s4.getText()), formatHhMm.parse(e4.getText()));
        }
        if (c5.isSelected()) {
            checkInterval(formatHhMm.parse(s5.getText()), formatHhMm.parse(e5.getText()));
        }
        if (c6.isSelected()) {
            checkInterval(formatHhMm.parse(s6.getText()), formatHhMm.parse(e6.getText()));
        }
        if (c7.isSelected()) {
            checkInterval(formatHhMm.parse(s7.getText()), formatHhMm.parse(e7.getText()));
        }
        schedule.setName(textFieldPlaneName.getText());
        schedule.setType(radioButtonWeek.isSelected() ? 0 : 1);
        schedule.setTimeBegin1(c1.isSelected() ? formatHhMm.parse(s1.getText()) : null);
        schedule.setTimeEnd1(c1.isSelected() ? formatHhMm.parse(e1.getText()) : null);
        schedule.setTimeBegin2(c2.isSelected() ? formatHhMm.parse(s2.getText()) : null);
        schedule.setTimeEnd2(c2.isSelected() ? formatHhMm.parse(e2.getText()) : null);
        schedule.setTimeBegin3(c3.isSelected() ? formatHhMm.parse(s3.getText()) : null);
        schedule.setTimeEnd3(c3.isSelected() ? formatHhMm.parse(e3.getText()) : null);
        schedule.setTimeBegin4(c4.isSelected() ? formatHhMm.parse(s4.getText()) : null);
        schedule.setTimeEnd4(c4.isSelected() ? formatHhMm.parse(e4.getText()) : null);
        schedule.setTimeBegin5(c5.isSelected() ? formatHhMm.parse(s5.getText()) : null);
        schedule.setTimeEnd5(c5.isSelected() ? formatHhMm.parse(e5.getText()) : null);
        schedule.setTimeBegin6(c6.isSelected() ? formatHhMm.parse(s6.getText()) : null);
        schedule.setTimeEnd6(c6.isSelected() ? formatHhMm.parse(e6.getText()) : null);
        schedule.setTimeBegin7(c7.isSelected() ? formatHhMm.parse(s7.getText()) : null);
        schedule.setTimeEnd7(c7.isSelected() ? formatHhMm.parse(e7.getText()) : null);

        schedule.setBreaks1((QBreaks) cb1.getSelectedItem());
        schedule.setBreaks2((QBreaks) cb2.getSelectedItem());
        schedule.setBreaks3((QBreaks) cb3.getSelectedItem());
        schedule.setBreaks4((QBreaks) cb4.getSelectedItem());
        schedule.setBreaks5((QBreaks) cb5.getSelectedItem());
        schedule.setBreaks6((QBreaks) cb6.getSelectedItem());
        schedule.setBreaks7((QBreaks) cb7.getSelectedItem());
    }
