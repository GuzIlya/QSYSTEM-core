...
/**
 * Диалог с предварительно обязательной важной информацией.
 *
 * @author egorov
 */
...
public class FPreInfoDialog extends javax.swing.JDialog {
    ...
    public FPreInfoDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        buttonBack.setVisible(!QConfig.cfg().isWelcomeInfo());
    ...
    /**
     * Покажем диалог с предварительно важной информацией.
     */
    public static boolean showPreInfoDialog(Frame parent, String htmlText, String printText, boolean modal, boolean fullscreen, int delay, boolean mayCancel) {
        ...
        log.info("Чтение обязательной информации перед постановкой в очередь");
    ...
    private void initComponents() {
        ...
        panelAll = new QPanel(WelcomeParams.getInstance().getBackgroundImg("preinfo"));
        panelUpPreInfo = new QPanel(WelcomeParams.getInstance().topImgSecondary);
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FPreInfoDialog.class);
        panelAll.setBackground(resourceMap.getColor("panelAll.background")); // NOI18N
        panelAll.setName("panelAll"); // NOI18N

        panelUpPreInfo.setBorder(new javax.swing.border.MatteBorder(null));
        panelUpPreInfo.setCycle(java.lang.Boolean.FALSE);
        panelUpPreInfo.setEndColor(resourceMap.getColor("panelUpPreInfo.endColor")); // NOI18N
        panelUpPreInfo.setEndPoint(new java.awt.Point(0, 70));
        panelUpPreInfo.setName("panelUpPreInfo"); // NOI18N
        panelUpPreInfo.setOpaque(false);
        panelUpPreInfo.setPreferredSize(new java.awt.Dimension(880, 150));
        panelUpPreInfo.setStartColor(resourceMap.getColor("panelUpPreInfo.startColor")); // NOI18N
        panelUpPreInfo.setStartPoint(new java.awt.Point(0, -50));
        ...
        javax.swing.GroupLayout panelUpPreInfoLayout = new javax.swing.GroupLayout(panelUpPreInfo);
        panelUpPreInfo.setLayout(panelUpPreInfoLayout);
        panelUpPreInfoLayout.setHorizontalGroup(
                panelUpPreInfoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addComponent(labelCaption2, javax.swing.GroupLayout.DEFAULT_SIZE, 1113, Short.MAX_VALUE)
        );
        panelUpPreInfoLayout.setVerticalGroup(
                panelUpPreInfoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance().getContext().getActionMap(FPreInfoDialog.class, this);
        ...
        panelAllLayout.setHorizontalGroup(
                panelAllLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addComponent(panelUpPreInfo, javax.swing.GroupLayout.DEFAULT_SIZE, 1115, Short.MAX_VALUE)
        ...
        panelAllLayout.setVerticalGroup(
                panelAllLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(panelAllLayout.createSequentialGroup()
                                .addComponent(panelUpPreInfo, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    @Action
    public void refuse() {
        log.debug("Отказ встать в очередь после чтения обязательной информации");
        result = false;
    ...
    public void printHint() {
        log.info("Печать подсказки об обязательной информации");
        FWelcome.printPreInfoText(printText);
    }

    /**
     * Встаем в очередь после чтения обязательной информации.
     */
    @Action
    public void proceed() {
        log.debug("Встаем в очередь после чтения обязательной информации");
        result = true;
        if (clockBack.isActive()) {
            clockBack.stop();
        }
    ...
    private ru.apertum.qsystem.client.model.QPanel panelUpPreInfo;
