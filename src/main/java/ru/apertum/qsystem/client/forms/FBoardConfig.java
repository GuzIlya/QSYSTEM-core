...
public class FBoardConfig extends AFBoardRedactor {
    ...
    @Override
    public void saveResult() throws QException {
        saveForm();
        super.saveResult();
    }
    ...
    protected void saveForm() {
        ...
        topElement.addAttribute(Uses.TAG_BOARD_PANEL_SIZE, String.valueOf(Uses.roundAs(spUp.getDividerLocation() / (spUp.getHeight() + 0.009d), 2)));
        leftElement.addAttribute(Uses.TAG_BOARD_PANEL_SIZE, String.valueOf(Uses.roundAs(spLeft.getDividerLocation() / (spLeft.getWidth() + 0.009d), 2)));
        rightElement.addAttribute(Uses.TAG_BOARD_PANEL_SIZE, String.valueOf(Uses.roundAs(spRight.getDividerLocation() / (spRight.getWidth() + 0.009d), 2)));
        bottomElement.addAttribute(Uses.TAG_BOARD_PANEL_SIZE, String.valueOf(Uses.roundAs(spDown.getDividerLocation() / (spDown.getHeight() + 0.009), 2)));
        bottomElement2.addAttribute(Uses.TAG_BOARD_PANEL_SIZE, String.valueOf(Uses.roundAs(spDown2.getDividerLocation() / (spDown2.getHeight() - 0.03), 2)));
    }

    protected void changeParamsTop(JFrame owner, Element params, String caption, INetProperty netProps) {
        FBoardParams.changeParams(owner, params, caption, netProps);
    }
    ...
    /**
     * Вот так мы обеспечим переопределение метода вызова редактирования параметров центрального сегмента.
     */
    ...
    private void panelUpComponentResized(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_panelUpComponentResized
        labelUp.setText(String.valueOf(Math.round((panelUp.getHeight() + 0d) / (spUp.getHeight()) * 100)) + "%");
    ...
    private void panelLeftComponentResized(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_panelLeftComponentResized
        labelLeft.setText(String.valueOf(Math.round((panelLeft.getWidth() + 0d) / (spUp.getWidth()) * 100)) + "%");
    ...
    private void panelRightComponentResized(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_panelRightComponentResized
        labelRight.setText(String.valueOf(Math.round((panelRight.getWidth() + 0d) / (panelUp.getWidth()) * 100)) + "%");
    ...
    private void buttonRightActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonRightActionPerformed
        changeParamsRight(this.parentFarame, rightElement, getLocaleMessage("cfg.params.right"), netProperty);
    }//GEN-LAST:event_buttonRightActionPerformed

    private void buttonDownActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonDownActionPerformed
        changeParamsBottom(this.parentFarame, bottomElement, getLocaleMessage("cfg.params.bottom"), netProperty);
    }//GEN-LAST:event_buttonDownActionPerformed

    private void buttonLeftActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonLeftActionPerformed
        changeParamsLeft(this.parentFarame, leftElement, getLocaleMessage("cfg.params.left"), netProperty);
    ...
    private void buttonTopActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonTopActionPerformed
        changeParamsTop(this.parentFarame, topElement, getLocaleMessage("cfg.params.top"), netProperty);
    ...
    private void buttonDown2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonDown2ActionPerformed
        changeParamsBottom2(this.parentFarame, bottomElement2, getLocaleMessage("cfg.params.bottom2"), netProperty);
    ...
    private void panelDown1ComponentResized(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_panelDown1ComponentResized
        labelDown.setText(String.valueOf(Math.round((panelDown1.getHeight() + 0d) / (spUp.getHeight() + panelDown2.getHeight()) * 100)) + "%");
    ...
    private void panelDown2ComponentResized(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_panelDown2ComponentResized
        labelDown2.setText(String.valueOf(Math.round((panelDown2.getHeight() + 0d) / (spUp.getHeight() + panelDown1.getHeight()) * 100)) + "%");
    }//GEN-LAST:event_panelDown2ComponentResized

    // Variables declaration - do not modify//GEN-BEGIN:variables
    protected javax.swing.JButton buttonDown;
    protected javax.swing.JButton buttonDown2;
    protected javax.swing.JButton buttonLeft;
    protected javax.swing.JButton buttonMain;
    protected javax.swing.JButton buttonRight;
    protected javax.swing.JButton buttonTop;
    protected javax.swing.JCheckBox checkBoxDown;
    protected javax.swing.JCheckBox checkBoxDown2;
    protected javax.swing.JCheckBox checkBoxLeft;
    protected javax.swing.JCheckBox checkBoxRight;
    protected javax.swing.JCheckBox checkBoxUp;
    protected javax.swing.JLabel labelDown;
    protected javax.swing.JLabel labelDown2;
    protected javax.swing.JLabel labelLeft;
    protected javax.swing.JLabel labelRight;
    protected javax.swing.JLabel labelUp;
    protected javax.swing.JPanel panelDown1;
    protected javax.swing.JPanel panelDown2;
    protected javax.swing.JPanel panelLeft;
    protected javax.swing.JPanel panelMain;
    protected javax.swing.JPanel panelRight;
    protected javax.swing.JPanel panelUp;
