...
public class FUserChangeDialog extends javax.swing.JDialog {
    ...
    public static void changeUser(Frame parent, boolean modal, QUser user) {
        log.info("Editing of user \"" + user + "\""); //NOI18N //NOI18N
        ...
        userChangeDialod.passwordFieldUser.setText(user.getParolcheg());
    ...
    private void saveUser() {
        ...
        user.setParolcheg(new String(userChangeDialod.passwordFieldUser.getPassword()));
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FUserChangeDialog.class);
