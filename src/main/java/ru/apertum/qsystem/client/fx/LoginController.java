    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        if (f.exists()) {
            ...
            try (FileInputStream fis = new FileInputStream(f);
                ...
                log.error("Ошибка чтения последнего успешного входа.", ex);
            }
        ...
        log.info("Login was initialized.");
    }
        ...
        if (usersCbx.getValue() == null) {
            ...
            if (usersCbx.getValue().getParolcheg().equals(inputPwd.getText())) {
                ...
                try {
                    ...
                    log.error("Вход в систему не выполнен. Пользователь \"" + getUser() + "\".", e);
                    servicesCheck = false;
                }
                if (servicesCheck) {
                    errorLbl.setVisible(false);
                    ...
                    log.info("Вход в систему выполнен. Пользователь \"" + getUser() + "\".");
                    ...
                    try {
                        ...
                        log.error("Ошибка сохранения последнего успешного входа.", ex);
                    }
