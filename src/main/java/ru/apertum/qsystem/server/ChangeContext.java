...
public class ChangeContext {
    ...
    public static void main(String[] args) throws IOException {
        ru.apertum.qsystem.QLauncher.run(args, ru.apertum.qsystem.common.QModule.server);
        ...
        while (!"".equals(str)) {
            ...
            if (!servs.isEmpty()) {
                ...
                if ("m".equals(str)) {
                    ...
                    str = read();
                    if (!"".equals(str) && str.matches(REG_EX_FLOAT) && Integer.parseInt(str) >= 1 && Integer.parseInt(str) <= servs.size()) {
                        servs.forEach(ser -> ser.setMain(Boolean.FALSE));
                ...
                if ("c".equals(str)) {
                    ...
                    str = read();
                    if (!"".equals(str) && str.matches(REG_EX_FLOAT) && Integer.parseInt(str) >= 1 && Integer.parseInt(str) <= servs.size()) {
                        servs.forEach(ser -> ser.setCurrent(Boolean.FALSE));
