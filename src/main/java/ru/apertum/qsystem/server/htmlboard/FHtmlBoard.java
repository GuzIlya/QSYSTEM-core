...
public class FHtmlBoard extends javax.swing.JFrame {
     ...
     */
    public void toPosition(boolean isDebug) {
        // Определим монитор
        final Rectangle bounds = Uses.DISPLAYS.get(ServerProps.getInstance().getPropertyInst(SECTION_MAIN_TABLO, "monitor", "1").getValueAsInt(1));
        int posx = 20;
        int posy = 20;
        if (bounds != null) {
            posx = bounds.x + 1;
