...
public class NetCommander {
    ...
    public static QCustomer standInSetOfServices(INetProperty netProperty, LinkedList<LinkedList<LinkedList<Long>>> servicesId, String password, int priority, String inputData)
        ...
        params.priority = priority;
        params.textData = inputData;
        final String res = send(netProperty, Uses.TASK_STAND_COMPLEX, params);
        return AJsonRPC20.demarshal(res, RpcStandInService.class).getResult().getCustomer();
    }
     ...
     */
    public static void changeTempAvailableService(INetProperty netProperty, long serviceId, String reason) throws QException {
    ...
    public static ServiceState aboutService(INetProperty netProperty, long serviceId) throws QException {
        ...
        final CmdParams params = new CmdParams();
        params.serviceId = serviceId;
        final String res = send(netProperty, Uses.TASK_ABOUT_SERVICE, params);
    ...
    public static int aboutServicePersonLimitOver(INetProperty netProperty, long serviceId, String inputData) throws QException {
        ...
        params.serviceId = serviceId;
        params.textData = inputData;
        String res = send(netProperty, Uses.TASK_ABOUT_SERVICE_PERSON_LIMIT, params);
        return AJsonRPC20.demarshal(res, RpcGetInt.class).getResult();
    }
    ...
    public static boolean getSelfServicesCheck(INetProperty netProperty, long userId) throws QException {
        ...
        return AJsonRPC20.demarshal(res, RpcGetBool.class).getResult();
    }
     ...
     * @return ответ-кастомер следующий по очереди.
     */
    public static QCustomer inviteNextCustomer(INetProperty netProperty, long userId, String num) throws QException {
     ...
     * @return ответ-кастомер следующий по очереди.
     */
    public static QCustomer inviteNextCustomer(INetProperty netProperty, long userId, String num, Long customerId) throws QException {
        log.info("Получение, блядь, любого кастомера из очередей юзера из очередей, обрабатываемых юзером.");
        // загрузим ответ
        final CmdParams params = new CmdParams();
        params.userId = userId;
        params.textData = num;
        ...
        final String res = send(netProperty, Uses.TASK_INVITE_NEXT_CUSTOMER, params);
        return AJsonRPC20.demarshal(res, RpcInviteCustomer.class).getResult();
    }
     ...
     */
    public static String getWelcomeState(INetProperty netProperty, String message, boolean dropTicketsCounter) throws QException {
     ...
     */
    public static String setServiseFire(INetProperty netProperty, long serviceId, long userId, int coeff) throws QException {
        ...
        params.serviceId = serviceId;
        params.coeff = coeff;
        final String res = send(netProperty, Uses.TASK_SET_SERVICE_FIRE, params);
        return AJsonRPC20.demarshal(res, RpcGetSrt.class).getResult();
    }
     ...
     * @return содержить строковое сообщение о результате.
     */
    public static String deleteServiseFire(INetProperty netProperty, long serviceId, long userId) throws QException {
        log.info("Удаление услуги пользователю на горячую.");
        // загрузим ответ
        final CmdParams params = new CmdParams();
        params.userId = userId;
        params.serviceId = serviceId;
        final String res = send(netProperty, Uses.TASK_DELETE_SERVICE_FIRE, params);
        return AJsonRPC20.demarshal(res, RpcGetSrt.class).getResult();
    }
     ...
     */
    public static Element getBoardConfig(INetProperty netProperty) throws DocumentException, QException {
        log.info("Получение конфигурации главного табло - ЖК или плазмы.");
        // загрузим ответ
        final String res = send(netProperty, Uses.TASK_GET_BOARD_CONFIG, null);
        return DocumentHelper.parseText(AJsonRPC20.demarshal(res, RpcGetSrt.class).getResult()).getRootElement();
    }
     ...
     */
    public static void saveBoardConfig(INetProperty netProperty, Element boardConfig) throws QException {
     ...
     */
    public static RpcGetGridOfDay.GridDayAndParams getPreGridOfDay(INetProperty netProperty, long serviceId, Date date, long advancedCustomer) throws QException {
        ...
        final String res = send(netProperty, Uses.TASK_GET_GRID_OF_DAY, params);
        return AJsonRPC20.demarshal(res, RpcGetGridOfDay.class).getResult();
    }
     ...
     * @return класс с параметрами и списком времен
     */
    public static RpcGetGridOfWeek.GridAndParams getGridOfWeek(INetProperty netProperty, long serviceId, Date date, long advancedCustomer) throws QException {
     ...
     * @return XML-ответ.
     */
    public static RpcStandInService.AdvResult standAndCheckAdvance(INetProperty netProperty, Long advanceID) throws QException {
        log.info("Постановка предварительно записанных в очередь.");
        // загрузим ответ
        final CmdParams params = new CmdParams();
        params.customerId = advanceID;
        final String res = send(netProperty, Uses.TASK_ADVANCE_CHECK_AND_STAND, params);
        return AJsonRPC20.demarshal(res, RpcStandInService.class).getResult();
    }
     ...
     * @return XML-ответ.
     */
    public static JsonRPC20OK removeAdvancedCustomer(INetProperty netProperty, Long advanceID) throws QException {
        log.info("Удаление предварительно записанных в очередь.");
        // загрузим ответ
        final CmdParams params = new CmdParams();
        params.customerId = advanceID;
        final String res = send(netProperty, Uses.TASK_REMOVE_ADVANCE_CUSTOMER, params);
        return AJsonRPC20.demarshal(res, JsonRPC20OK.class);
    }
     ...
     * @return XML-ответ
     */
    public static QRespItem getResporseList(INetProperty netProperty) throws QException {
        log.info("Команда на получение дерева отзывов.");
        String res = send(netProperty, Uses.TASK_GET_RESPONSE_LIST, null);
        if (res == null) {
            return null;
        } else {
            return AJsonRPC20.demarshal(res, RpcGetRespTree.class).getResult();
        }
    }
     ...
     * @return XML-ответ.
     */
    public static QInfoItem getInfoTree(INetProperty netProperty) throws QException {
        log.info("Команда на получение информационного дерева.");
        String res = send(netProperty, Uses.TASK_GET_INFO_TREE, null);
        if (res == null) {
            return null;
        } else {
            return AJsonRPC20.demarshal(res, RpcGetInfoTree.class).getResult();
        }
    }
     ...
     * @return XML-ответ.
     */
    public static QAuthorizationCustomer getClientAuthorization(INetProperty netProperty, String id) throws QException {
        log.info("Получение описания авторизованного пользователя.");
        // загрузим ответ
        final CmdParams params = new CmdParams();
        params.clientAuthId = id;
        final String res = send(netProperty, Uses.TASK_GET_CLIENT_AUTHORIZATION, params);
        return AJsonRPC20.demarshal(res, RpcGetAuthorizCustomer.class).getResult();
    }
     ...
     */
    public static LinkedList<QResult> getResultsList(INetProperty netProperty) throws QException {
        log.info("Команда на получение списка возможных результатов работы с клиентом.");
        final String res = send(netProperty, Uses.TASK_GET_RESULTS_LIST, null);
        return AJsonRPC20.demarshal(res, RpcGetResultsList.class).getResult();
    }
     ...
     */
    public static String setCustomerPriority(INetProperty netProperty, int prioritet, String customer) throws QException {
        log.info("Команда на повышение приоритета кастомеру.");
        // загрузим ответ
        final CmdParams params = new CmdParams();
        params.priority = prioritet;
        params.clientAuthId = customer;
        final String res = send(netProperty, Uses.TASK_SET_CUSTOMER_PRIORITY, params);
        return AJsonRPC20.demarshal(res, RpcGetSrt.class).getResult();
    }
     ...
     * @return Текстовый ответ о результате
     */
    public static TicketHistory checkCustomerNumber(INetProperty netProperty, String customerNumber) throws QException {
        log.info("Команда проверки номера кастомера.");
        // загрузим ответ
        final CmdParams params = new CmdParams();
        params.clientAuthId = customerNumber;
        final String res = send(netProperty, Uses.TASK_CHECK_CUSTOMER_NUMBER, params);
        return AJsonRPC20.demarshal(res, RpcGetTicketHistory.class).getResult();
    }
     ...
     */
    public static LinkedList<QCustomer> getPostponedPoolInfo(INetProperty netProperty) throws QException {
        log.info("Команда на обновление пула отложенных.");
        // загрузим ответ
        final String res = send(netProperty, Uses.TASK_GET_POSTPONED_POOL, null);
        return AJsonRPC20.demarshal(res, RpcGetPostponedPoolInfo.class).getResult();
    }
     ...
     * @return список отложенных кастомеров
     */
    public static LinkedList<String> getBanedList(INetProperty netProperty) throws QException {
        log.info("Команда получение списка забаненных.");
        // загрузим ответ
        final String res = send(netProperty, Uses.TASK_GET_BAN_LIST, null);
        return AJsonRPC20.demarshal(res, RpcBanList.class).getBanList();
    }
     ...
     */
    public static QCustomer invitePostponeCustomer(INetProperty netProperty, long userId, Long id) throws QException {
        log.info("Команда на вызов кастомера из пула отложенных.");
        final CmdParams params = new CmdParams();
        params.userId = userId;
        params.customerId = id;
        // загрузим ответ
        final String res = send(netProperty, Uses.TASK_INVITE_POSTPONED, params);
        return AJsonRPC20.demarshal(res, RpcInviteCustomer.class).getResult();
    }
    ...
    public static void setRunningText(INetProperty netProperty, String text, String nameSection) {
        log.info("Изменение бегущей строки на табло из админской проги.");
        // загрузим ответ
        final CmdParams params = new CmdParams();
     ...
     */
    public static LinkedHashMap<String, ServerProps.Section> saveProperties(INetProperty netProperty, List<QProperty> properties) throws QException {
        log.info("Изменить и сохранить параметеры в ДБ на сервере.");
        final CmdParams params = new CmdParams();
        params.properties = properties;
        // загрузим ответ
        final String res = send(netProperty, Uses.TASK_SAVE_PROPERTIES, params);
        return AJsonRPC20.demarshal(res, RpcGetProperties.class).getResult();
    }
     ...
     */
    public static void initRoll(INetProperty netProperty, Long serviceId, int first, int last, int current) throws QException {
        log.info("Изменение приоритетов услуг оператором.");
        final CmdParams params = new CmdParams();
        params.serviceId = serviceId;
        params.first = first;
