...
public final class QConfig {
    ...
    private static final String KEY_WELCOME_MODE = "welcome-mode";
    private static final String KEY_WELCOME_TOUCH = "touch";
    private static final String KEY_WELCOME_INFO = "info";
    public static final String KEY_WELCOME_BTN = "btn";
    public static final String KEY_WELCOME_KBD = "kbd";
    public static final String KEY_WELCOME_FEEDBACK = "feedback";
    ...
    private Options initOptions(QModule type) {
        ...
        if (type.isUnknown() || type.isClient() || type.isDesktop()) {
            ...
            options.addOption(option);
            options.addOption("v", KEY_VOICE, false, "Invite by voice from client app.");
    ...
    /**
     * Редим мед всегда отключен и не поддерживается.
     *
     * @return false.
     */
    ...
    public String getLog4j2Cfg() {
        return line.hasOption(KEY_LOG4J2_CONFIG) && Paths.get(config.getString(KEY_LOG4J2_CONFIG)).toFile().exists() ? config.getString(KEY_LOG4J2_CONFIG) : null;
    }
    ...
    /**
     * touch,info,med,btn,kbd,feedback.
     *
     * @return mode.
     */
    ...
    /**
     * -wm(--welcome-mode) KEY_WELCOME_BTN.
     *
     * @return mode is KEY_WELCOME_BTN.
     */
    public boolean isWelcomeHardwareButtons() {
        return KEY_WELCOME_BTN.equalsIgnoreCase(getWelcomeMode());
    }

    /**
     * -wm(--welcome-mode) KEY_WELCOME_TOUCH.
     *
     * @return mode is KEY_WELCOME_TOUCH.
     */
    public boolean isWelcomeTouch() {
        return KEY_WELCOME_TOUCH.equalsIgnoreCase(getWelcomeMode());
    }

    /**
     * -wm(--welcome-mode) KEY_WELCOME_KBD.
     *
     * @return mode is KEY_WELCOME_KBD.
     */
    public boolean isWelcomeKeyboard() {
        return KEY_WELCOME_KBD.equalsIgnoreCase(getWelcomeMode());
    }

    /**
     * -wm(--welcome-mode) KEY_WELCOME_FEEDBACK.
     *
     * @return mode is KEY_WELCOME_FEEDBACK.
     */
    public boolean isWelcomeFeedback() {
        return KEY_WELCOME_FEEDBACK.equalsIgnoreCase(getWelcomeMode());
    }
    ...
    /**
     * По входным параметрам из консоли создадим объект с адресом и портами в сети.
     *
     * @return хранилище сетевых параметров.
     */
    public IClientNetProperty getClientNetProperty() {
        return new IClientNetProperty() {
            @Override
            public Integer getClientPort() {
                return QConfig.this.getClientPort();
            }
